    ...
    <div className="ha-root" style={{
      ...
      <TweaksPanel>
        ...
        <TweakColor label="Primary" value={t.primaryColor}
          options={["#1d4e89", "#2e7d52", "#0f766e", "#b4540a"]}
          onChange={(v) => setTweak("primaryColor", v)} />
        <TweakSection label="Surfaces" />
        <TweakSlider label="Card radius" value={t.cardRadius} min={4} max={24} unit="px"
          onChange={(v) => setTweak("cardRadius", v)} />
        <TweakRadio label="Catalog density" value={t.catalogDensity} options={["cozy", "compact"]}
          onChange={(v) => setTweak("catalogDensity", v)} />
      </TweaksPanel>
    </div>
  );
};
